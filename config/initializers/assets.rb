...
Rails.application.config.assets.precompile += %w( hofsList.js )
...
Rails.application.config.assets.precompile += %w( parksMap.js )
Rails.application.config.assets.precompile += %w( parksMap.css )
