...
class MotionsControllerTest < ActionController::TestCase
  ...
  test "should create motion" do
    assert_difference('Motion.count') do
      post :create, motion: { description: @motion.description, is_active: @motion.is_active, is_anonymous: @motion.is_anonymous, title: @motion.title }
    end
  ...
  test "should update motion" do
    patch :update, id: @motion, motion: { description: @motion.description, is_active: @motion.is_active, is_anonymous: @motion.is_anonymous, title: @motion.title }
    assert_redirected_to motion_path(assigns(:motion))
  end
