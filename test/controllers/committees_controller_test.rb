...
class CommitteesControllerTest < ActionController::TestCase
  ...
  test "should create committee" do
    assert_difference('Committee.count') do
      post :create, committee: { email: @committee.email, name: @committee.name, profile_id: @committee.profile_id }
    end
  ...
  test "should update committee" do
    patch :update, id: @committee, committee: { email: @committee.email, name: @committee.name, profile_id: @committee.profile_id }
    assert_redirected_to committee_path(assigns(:committee))
  end
